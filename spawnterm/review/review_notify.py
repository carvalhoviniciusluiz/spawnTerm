...
This is the thin, testable seam the shell ``spawnterm-review`` tool shells out
...
the caller (``spawnterm-review``) falls back to a file-in-the-worktree note; this
