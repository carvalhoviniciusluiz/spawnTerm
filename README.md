> # it2agent
> **This repository is [it2agent](it2agent/README.md)** — a project to orchestrate multiple AI
...
> Tier 4** (upstream core PRs). **Start at [Epic #1](../../issues/1) and [`it2agent/`](it2agent/).**
>
> ---
>
